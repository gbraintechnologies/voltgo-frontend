...
import {
  ...
  Animated, StatusBar, Image, Platform,
} from 'react-native';
...
export default function DeliveryCompleteScreen() {
  ...
  const { riderName = 'John Cena', riderRating = 4.5, itemType = 'Parcel' } = route.params ?? {};
  ...
  useEffect(() => {
    Animated.parallel([
      ...
      Animated.spring(scaleIn, { toValue: 1, tension: 60, friction: 8, useNativeDriver: true }),
    ]).start();
  }, []);
      ...
      <Animated.View style={[styles.content, { opacity: fadeIn, transform: [{ scale: scaleIn }] }]}>
        ...
        <View style={styles.successCircle}>
          <Svg width={44} height={44} viewBox="0 0 24 24" fill="none">
            <Path d="M20 6L9 17L4 12" stroke={Colors.successText}
        ...
        <View style={styles.riderCard}>
          ...
          */}
          {/* <Image
            ...
            style={styles.avatar}
          /> */}
                      <Image source={require('../../assets/images/rider_john.png')} style={styles.avatar} />
          ...
          <View style={styles.ratingDisplay}>
            <Svg width={14} height={14} viewBox="0 0 10 10" fill="none">
              <Path d="M5 1L6.18 3.64L9 4.07L7 6.12L7.47 9L5 7.64L2.53 9L3 6.12L1 4.07L3.82 3.64L5 1Z"
                fill="#FFB800" />
            </Svg>
...
const styles = StyleSheet.create({
  ...
  heading: {
    fontFamily: 'HelveticaNeue-CondensedBold', fontSize: 32,
    color: Colors.textPrimary, letterSpacing: 0.3, marginBottom: 10,
  },
  subheading: {
    fontFamily: 'Poppins-Regular', fontSize: 15,
    color: Colors.textMuted, textAlign: 'center', lineHeight: 22, marginBottom: 32,
  },
  riderCard: {
  ...
  riderInfo: { flex: 1 },
  riderName: {
    fontFamily: 'Poppins-SemiBold', fontSize: 15, color: Colors.textPrimary,
  },
  riderSub: {
    fontFamily: 'Poppins-Regular', fontSize: 12, color: Colors.textMuted, marginTop: 2,
  },
  ratingDisplay: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  ratingNum: {
    fontFamily: 'Poppins-SemiBold', fontSize: 14, color: Colors.textPrimary,
  },
  rateLabel: {
  ...
  footer: {
    paddingBottom: Platform.OS === 'ios' ? 36 : 24, paddingTop: 10, gap: 10,
  },
  doneBtn: {
